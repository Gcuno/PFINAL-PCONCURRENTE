	...
	$('#btnSend').click(function(){
		...
		if( validacion == '' == false){
			...
			$('body').append(mensajeModal);
                    ...
                    $.post("mail",envioDato, function(datos){
                        var mensajeModal =	'<div class="modal_wrap">'+
									'<div class="mensaje_modal">'+
										'<h3>Peticion concedida</h3>'+
										datos+
										'<span><a href="index.jsp" style="text-decoration: none; background: linear-gradient(90deg, #E30F87, #BF4222);border: none;border-radius: 25px;" class="btn_close" id="btnClose">Ir a la pagina Principal</a></span>'
									'</div>'+
								'</div>';
