...
<%
   ControladorProducto h_zandalias = new ControladorProducto();
%>
...
<html>
    ...
    <link href="../../css/estilos.css" rel="stylesheet">
        ...
        <title>Zandalias para Hombre | Daoko</title>
        </head>
		...
		<li><a href="../../principal.jsp">Inicio</a></li> 								                            											
			...
			<span class="badge pull-right"><i class="fa fa-plus"></i></span>Marcas</a></h4>
                        ...
                        <li><a href="../Marcas/marcas-puma.jsp">Puma</a></li></ul></div>
                           ...
                           <ul>
                           <li><a href="H-deportivas.jsp">Deportivas</a></li>
                           <li><a href="H-vestir.jsp">Vestir</a></li>
                           <li><a href="H-casual.jsp">Casual</a></li>
                           <li><a href="H-zandalias.jsp">Zandalias</a></li>							
                           </ul>
                                 </div>
                                        </div>
                                                </div>
            ...
            <div class="col-sm-9 padding-right">       <!--La seccion de los productos que esta al lado derecho decategoria-->                                                 
                                <div class="productos-recomendados">                           
                                    <h2 class="titulo text-center">ZANDALIAS</h2>                           
                                    
                                         <%= h_zandalias.getProductos_h_zandalias()%>  
                                        </div>
                                </div>                                    											
                        </div>
                </div>                        
