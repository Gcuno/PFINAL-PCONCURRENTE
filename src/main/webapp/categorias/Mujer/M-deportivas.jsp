...
<%
   ControladorProducto m_deportivas = new ControladorProducto();
%>
...
<html>
   ...
   <script src="../../js/jquery.js"></script>
    ...
    <link href="../../css/estilos.css" rel="stylesheet">
        ...
        <title>Deportivas para Mujeres | Daoko</title>
        </head>
		...
		<li><a href="principal.jsp">Inicio</a></li> 								                            											
			...
			<span class="badge pull-right"><i class="fa fa-plus"></i></span>Marcas</a></h4>
                        ...
                        <div class="panel panel-default"><!--Seccion de mujeres con su submenu --> 
                            ...
                            <div class="panel-cuerpo"> 
                            <ul>
                            <li><a href="M-deportivas.jsp">Deportivas Mujer</a></li>
                            <li><a href="M-casual.jsp">Casual</a></li>
                            <li><a href="M-tacones.jsp">Tacones</a></li>
                            </ul>
                                   </div>
                                           </div>
                                                   </div>
            ...
            <div class="col-sm-9 padding-right">       <!--La seccion de los productos que esta al lado derecho decategoria-->                                                 
                                <div class="productos-recomendados">                           
                                    <h2 class="titulo text-center">Zapatillas Deportivas </h2>                           
                                    
                                                 <%= m_deportivas.getProductos_m_deportivas()%>    
                                                </div>
                                        </div>
