...
<%
   ControladorProducto adidas = new ControladorProducto();
%>
...
<html>
    ...
    <link href="v../css/estilos.css" rel="stylesheet">
   <link href="../../css/estilos.css" rel="stylesheet">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Adidas | Daoko</title>
        </head>
	...
	<ul class="nav nav-pills">
        ...
        <li><a href="../../contacto.jsp"><i class="fa fa-envelope"></i> malasbro11@gmail.com</a></li></ul>
            ...
            <li><a href="https://twitter.com/Daoko46407886"><i class="fa fa-twitter"></i></a></li></ul>
                                            </div>
                                    </div>
                        </div>
                </div>
    ...
    <div class="header-medio">
		...
		<li><a href="../../principal.jsp">Inicio</a></li>										                            											
			...
			<span class="badge pull-right"><i class="fa fa-plus"></i></span>Marcas</a></h4>
                        ...
                        <li><a href="marcas-nike.jsp">Nike </a></li>
                        <li><a href="marcas-converse.jsp">Converse</a></li>
                        <li><a href="marcas-adidas.jsp">Adidas </a></li>
                        <li><a href="marcas-puma.jsp">Puma</a></li></ul></div>
                        </div>
                        </div>
            ...
            <div class="col-sm-9 padding-right">       <!--La seccion de los productos que esta al lado derecho decategoria-->                                                 
                                <div class="productos-recomendados">                           
                                    <h2 class="titulo text-center">ADIDAS</h2>                           
                                    
                                        <%= adidas.getProductos_adidas()%>     
